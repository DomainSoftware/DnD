...
## Game State Changes
The file `state/session-5.json` has been updated with:
...
## Comment to Post to Issue #5

The following narrative comment should be posted to [Issue #5](https://github.com/DomainSoftware/DnD/issues/5):
